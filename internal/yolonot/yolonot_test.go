...
func TestAllowRedirectPatternsInFastAllow(t *testing.T) {
	...
	if ok, _ := fastallow.IsLocallySafeWith(`ls > $(echo /tmp/build/x)`, []string{"/tmp/build/*"}); ok {
